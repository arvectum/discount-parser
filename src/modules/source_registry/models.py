...
class RegisteredSource(Base):
    ...
    item_selector: Mapped[str | None] = mapped_column(Text)
    title_selector: Mapped[str | None] = mapped_column(Text)
    promo_code_selector: Mapped[str | None] = mapped_column(Text)
    promo_code_attribute: Mapped[str | None] = mapped_column(String(120))
    conditions_selector: Mapped[str | None] = mapped_column(Text)
    valid_until_selector: Mapped[str | None] = mapped_column(Text)
    link_selector: Mapped[str | None] = mapped_column(Text)
    reveal_selector: Mapped[str | None] = mapped_column(Text)
    reveal_code_attribute: Mapped[str | None] = mapped_column(String(120))
